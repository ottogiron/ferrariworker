...
func init() {
	...
	processCmd.PersistentFlags().String(workerIDKey, "workerId123", "The WorkerID generated by a ferrariserver")
	...
	viper.BindPFlag(workerIDKey, processCmd.PersistentFlags().Lookup(workerIDKey))
